...
$_['text_preload']			= 'Url preload';
$_['info_preload']			= 'With stores with lot of products and categories there could be lot of request to database to get all different urls,<br/>this setting is improving performance by preloading in memory all the urls for faster access';
...
$_['text_editor_seo_h1']						= 'SEO H1';
$_['text_editor_seo_h2']						= 'SEO H2';
$_['text_editor_seo_h3']						= 'SEO H3';
...
$_['text_editor_referer']	= 'Referer/Bot';
...
$_['entry_robots_tag'] = 'Tag page';
$_['entry_robots_tag_i'] = 'Default robots value for tag pages';
...
$_['text_tab_webmaster'] = 'Webmaster/Console';
$_['entry_google_webmaster'] = 'Google Search Console';
$_['entry_bing_webmaster'] = 'Bing Webmaster';
$_['entry_yandex_webmaster'] = 'Yandex Webmaster';
$_['text_info_analytics_main'] = '<p><i class="fa fa-info-circle"></i> Google analytics can provide detailled information and statistics related customer usage of your website.</p><p>It is not mandatory and does not impact the seo performance, but it can be helpful for you to improve your website.</p>';
$_['text_info_webmaster'] = '<p><i class="fa fa-info-circle"></i> Configure here the site verification to check your website on webmaster tools of google, bing, yandex, etc.</p><p>These webmaster/console tools are providing various statistics and informations about the health of your website, which may help you to identify if there is any issues with SEO or indexation of your urls.</p><p>You will just need to create account on corresponding websites and then enter the verification code here.</p><p>It is not mandatory and does not impact the seo performance, but it can be helpful for you to improve your website.</p>';
$_['text_info_webmaster1'] = '<h4>Verify your website on Google Search Console</h4>
<ol>
<li>Connect to <a href="https://search.google.com/search-console" target="_blank">Google Search Console</a></li>
<li>Click on <b>ADD A PROPERTY</b></li>
<li>Choose property type: <b>URL prefix</b></li>
<li>Choose verification method: <b>HTML tag</b></li>
<li>Copy the tag into "<b>Google Search Console</b>" field of this section</li>
</ol>';
$_['text_info_webmaster2'] = '<h4>Verify your website on Bing Webmaster</h4>
<ol>
<li>Connect to <a href="https://www.bing.com/webmasters" target="_blank">Bing Webmaster</a></li>
<li>Enter your website url into <b>Add your site manually</b></li>
<li>Choose verification method: <b>HTML Meta Tag</b></li>
<li>Copy the tag into "<b>Bing Webmaster</b>" field of this section</li>
</ol>';
$_['text_info_webmaster3'] = '<h4>Verify your website on Yandex Webmaster</h4>
<ol>
<li>Connect to <a href="https://webmaster.yandex.com/" target="_blank">Yandex Webmaster</a></li>
<li>Enter your website url into <b>Add your site manually</b></li>
<li>Choose verification method: <b>Meta Tag</b></li>
<li>Copy the tag into "<b>Yandex Webmaster</b>" field of this section</li>
</ol>';
...
$_['text_fpp_mode_5']   = 'First category';
