...
$_['text_paste_controller']      = 'Вставьте в файл контроллера (.php) код:';
$_['text_paste_temlate']      = 'Вставьте в файл шаблона (.twig) код:';
$_['text_form_name']      = 'Заголовок формы';
...
$_['text_error_name_module']      = 'Название модуля должно быть заполнено';
...
$_['table_fiald_status'] = 'Статус';
$_['table_fiald_required'] = 'Обязательное';
...
$_['text_feedback_list'] = 'Cообщения';
$_['text_filter_name_form'] = 'Форма';
$_['text_filter_text_form'] = 'Текст';
