      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <div class="pull-right">
            <button type="button" id="btn-clear-cache" class="btn btn-warning"><i class="fa fa-eraser"></i> <?php echo $button_clear_cache; ?></button>
              ...
              <div class="tab-pane" id="tab-2">
                ...
                <div class="tab-pane" id="tab-opt-2">
                  <table class="form">
                    ...
                    <tr>
                      <td><?php echo $_language->get('entry_hreflang'); ?></td>
                      <td><input class="switch" type="checkbox" name="advanced_sitemap_hreflang" id="advanced_sitemap_hreflang" value="1" <?php if(!empty($advanced_sitemap_hreflang)) echo 'checked="checked"'; ?>/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td><?php echo $_language->get('entry_no_count'); ?></td>
                      <td><input class="switch" type="checkbox" name="advanced_sitemap_cfg[no_count]" id="advanced_sitemap_cfg_no_count" value="1" <?php if(!empty($advanced_sitemap_cfg['no_count'])) echo 'checked="checked"'; ?>/></td>
                    </tr>
                    <tr>
...
<script>
  $(document).ready(function(){
    $('#btn-clear-cache').on('click', function(){
      Swal.fire({
        title: 'Are you sure?',
        text: "Do you want to clear cache?",
        icon: 'warning',
        ...
        if (result.value) {
          $.post('index.php?route=feed/advanced_sitemap/clearCache&<?php echo $token; ?>', {}, function(data){
            Swal.fire(
              'Success!',
              'Removed '+ data.counter+ ' file(s)',
              'success'
            );
          });
        }
