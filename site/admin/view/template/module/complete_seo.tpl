<?php echo $header; ?>
<div class="page-header" style="height:1px;visibility:hidden;margin:0"></div>
          ...
          <div class="instructions" style="min-height:200px;">
            <div class="seo_pack_pro well">
              ...
              <ol>
                ...
                <li>OC 2.x - 3.x: Disable in Extension > Modification the modification "Opencart SEO Pack PRO"</li>
                <li>OC 1.x: Delete these modification files from /vqmod/xml/ folder:
                  <ul>
                    <li>autolinks.xml</li>
  ...
  <?php } ?>
    ...
    <?php } ?>
        ...
        ?>
                ...
                <?php if (in_array($type, array('redirect', 'absolute', 'autolink'))) { ?>
                  <th data-column="query"><i class="fa fa-link gkd-badge"></i> <?php echo $_language->get('text_editor_query_'.$type); ?></th>
								...
								<?php } else if ($type == '404') { ?>
									...
									<th data-column="referer"><?php echo $_language->get('text_editor_referer'); ?></th>
                  ...
                  <?php if (in_array($type, array('product'))) { ?>
										<?php if (!$store_id) { ?><th data-column="related"><i class="fa fa-code-fork gkd-badge darkblue"></i> <?php echo $_language->get('text_editor_related'); ?></th><?php } ?>
                    <th data-column="seo_h1"><i class="fa fa-code gkd-badge green"></i> <?php echo $_language->get('text_editor_seo_h1'); ?></th>
                    <th data-column="seo_h2"><i class="fa fa-code gkd-badge green"></i> <?php echo $_language->get('text_editor_seo_h2'); ?></th>
                    <th data-column="seo_h3"><i class="fa fa-code gkd-badge green"></i> <?php echo $_language->get('text_editor_seo_h3'); ?></th>
									<?php } ?>
								<?php } ?>
							</tr>
						</thead>
          ...
          <div>&nbsp;
            ...
            <?php 
            if ($store_id) {
              $visColumns = array('image', 'name', 'url', 'meta_title', 'meta_keyword', 'meta_description', 'seo_h1', 'seo_h2', 'seo_h3');
            } else {
              $visColumns = array('image', 'name', 'url', 'meta_title', 'meta_keyword', 'meta_description', 'tag', 'related', 'seo_h1', 'seo_h2', 'seo_h3');
            }
            
            foreach($visColumns as $colIndex => $colType) {
            ?>
              ...
              <td colspan="2" style="padding-top:25px">
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><input class="checkable" data-label="<?php echo $_language->get('text_preload'); ?>" type="checkbox" name="mlseo_preload" value="1" <?php if (!empty($mlseo_preload)) echo 'checked="checked"'; ?>/></td>
                      <td><?php echo $_language->get('info_preload'); ?></td>
                    </tr>
                    <?php } ?>
                  </tbody>
                </table>
    ...
    <div class="tab-pane" id="tab-general-8">
      ...
      <div class="tab-pane" id="tab-general-10">
        <div class="alert alert-warning"><i class="fa fa-info-circle"></i> This option is deprecated, google is now able to index dynamically loaded content so it is not as useful as before to use this, anyway it is still available in case you want to activate it.</div>
        <table class="form">
          <tr>
      ...
      <div class="tab-pane" id="tab-general-13">
        <table class="form">
          ...
          <?php foreach (array('product', 'category', 'manufacturer', 'information', 'tag', 'account', 'checkout') as $type) { ?>
          <tr>
    ...
    <div class="tab-pane <?php echo $currentTab == 'tab-analytics' ? 'active' : '' ?>" id="tab-analytics">
       <ul class="nav nav-pills nav-stacked col-md-2">
				<li class="active"><a href="#tab-analytics-1" data-toggle="pill"><i class="fa fa-line-chart"></i> <?php echo $_language->get('text_gg_analytics'); ?></a></li>
				<li><a href="#tab-analytics-2" data-toggle="pill"><i class="fa fa-desktop"></i> <?php echo $_language->get('text_tab_webmaster'); ?></a></li>
			</ul>
			<div class="tab-content col-md-10">
        <div class="tab-pane active" id="tab-analytics-1">
          <table class="form">
            <tr>
              <td colspan="2"><div class="jumbo"><?php echo $_language->get('text_info_analytics_main'); ?></div></td>
            </tr>
            <tr>
        ...
        <div class="tab-pane" id="tab-analytics-2">
          <table class="form">
            <tr>
              <td colspan="2"><div class="jumbo"><?php echo $_language->get('text_info_webmaster'); ?></div></td>
            </tr>
            <tr>
              <td><i class="fa fa-google gkd-badge green"></i> <?php echo $_language->get('entry_google_webmaster'); ?></td>
              <td>
                <p><input type="text" class="form-control" name="mlseo_store[<?php echo $store_id; ?>][google]" value="<?php echo isset($mlseo_store[$store_id]['google']) ? $mlseo_store[$store_id]['google'] : ''; ?>" placeholder="&lt;meta name='google-site-verification' content='****'/&gt;"/></p>
                <p><a href="https://search.google.com/search-console" target="_blank"><i class="fa fa-external-link"></i> <?php echo $_language->get('entry_google_webmaster'); ?></a></p>
              </td>
            </tr>
            <tr>
              <td><i class="fa fa-__ gkd-badge blue"><b>B</b></i> <?php echo $_language->get('entry_bing_webmaster'); ?></td>
              <td>
                <p><input type="text" class="form-control" name="mlseo_store[<?php echo $store_id; ?>][bing]" value="<?php echo isset($mlseo_store[$store_id]['bing']) ? $mlseo_store[$store_id]['bing'] : ''; ?>" placeholder="&lt;meta name='msvalidate.01' content='****'/&gt;"/></p>
                <p><a href="https://www.bing.com/webmasters" target="_blank"><i class="fa fa-external-link"></i> <?php echo $_language->get('entry_bing_webmaster'); ?></a></p>
              </td>
            </tr>
            <tr>
              <td><i class="fa fa-__ gkd-badge red"><b>Y</b></i> <?php echo $_language->get('entry_yandex_webmaster'); ?></td>
              <td>
                <p><input type="text" class="form-control" name="mlseo_store[<?php echo $store_id; ?>][yandex]" value="<?php echo isset($mlseo_store[$store_id]['yandex']) ? $mlseo_store[$store_id]['yandex'] : ''; ?>" placeholder="&lt;meta name='yandex-verification' content='****'/&gt;"/></p>
                <p><a href="https://webmaster.yandex.com" target="_blank"><i class="fa fa-external-link"></i> <?php echo $_language->get('entry_yandex_webmaster'); ?></a></p>
              </td>
            </tr>
          </table>
          <div>&nbsp;
            <div class="gkdwidget gkdwidget-color-blueDark">
              <header role="heading">
                <i class="icon fa fa-info-circle fa-2x pull-left"></i>
                <ul class="nav nav-tabs pull-left in">
                  <li><a data-toggle="tab" href="#gkhelp<?php echo $gkhtab++; ?>"><?php echo $_language->get('entry_google_webmaster'); ?></a></li>
                  <li><a data-toggle="tab" href="#gkhelp<?php echo $gkhtab++; ?>"><?php echo $_language->get('entry_bing_webmaster'); ?></a></li>
                  <li><a data-toggle="tab" href="#gkhelp<?php echo $gkhtab++; ?>"><?php echo $_language->get('entry_yandex_webmaster'); ?></a></li>
                </ul>
              </header>
              <div class="gkdwidget-container" style="display:none">
                <div class="tab-content">
                  <div class="tab-pane" id="gkhelp<?php echo $gkhdiv++; ?>"><?php echo $_language->get('text_info_webmaster1'); ?></div>
                  <div class="tab-pane" id="gkhelp<?php echo $gkhdiv++; ?>"><?php echo $_language->get('text_info_webmaster2'); ?></div>
                  <div class="tab-pane" id="gkhelp<?php echo $gkhdiv++; ?>"><?php echo $_language->get('text_info_webmaster3'); ?></div>
                </div>
              </div>
            </div>
          </div>
              ...
              <table class="form">
                ...
                <!-- tr>
                  ...
                  <td class="checkboxinline">
                    ...
                    <div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> This is not recommended by google and can lead to bad ranking, make sure you know what you do before enabling this option</div>
            ...
            <tr>
              ...
              <td>
                <select name="mlseo_fpp_mode" class="form-control">
                  ...
                  <option value="5" <?php if ($mlseo_fpp_mode == '5') echo 'selected="selected"'; ?>><?php echo $_language->get('text_fpp_mode_5'); ?></option>
            ...
            <tr>
              ...
              <td>
                <select name="mlseo_fpp_bc_mode" class="form-control">
                  ...
                  <option value="5" <?php if ($mlseo_fpp_bc_mode == '5') echo 'selected="selected"'; ?>><?php echo $_language->get('text_fpp_mode_5'); ?></option>
    ...
    <?php if ($store_id) { ?>
		<div class="tab-pane<?php if ($store_id && (empty($currentTab) || $currentTab == 'tab-multistore')) echo ' active'; ?>" id="tab-multistore">
      <div class="well">
          ...
          <table class="generator table table-bordered table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><input type="text" name="mlseo_product_image_name_pattern" value="<?php echo $mlseo_product_image_name_pattern; ?>" class="form-control"  placeholder="[name];img2-[model];img3-[name]"/></td>
...
// reload with all same parameters (keeps current page)
function refreshCurrentTable() {
	editor_type = $('#tabs_editor li.active > a').attr('editor-type');
  
	$('#seo_editor_'+editor_type).dataTable().api().ajax.reload(null, false);
}
  ...
  $('body').on('click', '.modal-related', function() {
	...
	$('.seo_editor').on('click', '.deleteAlias', function(e) {
      ...
      editor_type = $('#tabs_editor > li.active > a').attr('editor-type');
			$.ajax({
				...
				success: function(){ refreshCurrentTable(); }
			});
		}
	});
	...
	$('.modal').on('click', '.addAlias', function(e) {
		...
		$.ajax({
			...
			success: function(){ $('#newAliasModal').modal('hide'); refreshCurrentTable(); }
		});
	});
