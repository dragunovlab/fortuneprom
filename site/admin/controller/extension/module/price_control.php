...
class ControllerExtensionModulePriceControl extends Controller
{
    ...
    public function install()
    {
        ...
        $this->model_setting_setting->editSetting('module_price_control', array('module_price_control_status' => 1));
    }
    ...
    public function uninstall()
    {
        ...
        $this->model_setting_setting->editSetting('module_price_control', array('module_price_control_status' => 0));
