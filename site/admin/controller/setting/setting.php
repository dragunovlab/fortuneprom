...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_telegram_bot'])) {
			$data['config_telegram_bot'] = $this->request->post['config_telegram_bot'];
		} else {
			$data['config_telegram_bot'] = $this->config->get('config_telegram_bot');
		}
		
		if (isset($this->request->post['config_telegram_recipients'])) {
			$data['config_telegram_recipients'] = $this->request->post['config_telegram_recipients'];
		} elseif ($this->config->has('config_telegram_recipients')) {
			$data['config_telegram_recipients'] = $this->config->get('config_telegram_recipients');
		} else {
			$data['config_telegram_recipients'] = array();
		}
